	...
	extends TransformerAbstract
	{
		...
		public function transform($data) {
			...
			return array_merge(array(
				...
				'q65_date[month]' => (!isset($data['answers'][65]['answer']['month']) ? NULL : $data['answers'][65]['answer']['month']),
				'q65_date[day]' => (!isset($data['answers'][65]['answer']['day']) ? NULL : $data['answers'][65]['answer']['day']),
				'q65_date[year]' => (!isset($data['answers'][65]['answer']['year']) ? NULL : $data['answers'][65]['answer']['year']),
				'q66_date[month]' => (!isset($data['answers'][66]['answer']['month']) ? NULL : $data['answers'][66]['answer']['month']),
				'q66_date[day]' => (!isset($data['answers'][66]['answer']['day']) ? NULL : $data['answers'][66]['answer']['day']),
				'q66_date[year]' => (!isset($data['answers'][66]['answer']['year']) ? NULL : $data['answers'][66]['answer']['year']),
				'q67_date[month]' => (!isset($data['answers'][67]['answer']['month']) ? NULL : $data['answers'][67]['answer']['month']),
				'q67_date[day]' => (!isset($data['answers'][67]['answer']['day']) ? NULL : $data['answers'][67]['answer']['day']),
				'q67_date[year]' => (!isset($data['answers'][67]['answer']['year']) ? NULL : $data['answers'][67]['answer']['year']),
				'q68_date[month]' => (!isset($data['answers'][68]['answer']['month']) ? NULL : $data['answers'][68]['answer']['month']),
				'q68_date[day]' => (!isset($data['answers'][68]['answer']['day']) ? NULL : $data['answers'][68]['answer']['day']),
				'q68_date[year]' => (!isset($data['answers'][68]['answer']['year']) ? NULL : $data['answers'][68]['answer']['year']),
				'q69_date[month]' => (!isset($data['answers'][69]['answer']['month']) ? NULL : $data['answers'][69]['answer']['month']),
				'q69_date[day]' => (!isset($data['answers'][69]['answer']['day']) ? NULL : $data['answers'][69]['answer']['day']),
				'q69_date[year]' => (!isset($data['answers'][69]['answer']['year']) ? NULL : $data['answers'][69]['answer']['year']),
